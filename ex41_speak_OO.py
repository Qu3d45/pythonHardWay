# Learn Pyhton The Hard Way ex41 - Learning to Speak Object Oriented
# Manuel Lameira
...
# inheritance   The concept that one class can inherit traits from
...
# attribute     A property classes have that are from composition and
